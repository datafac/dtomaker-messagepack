...
namespace MyOrg.DomainB.MessagePack
{
    ...
    public partial class MyDTO2 : DTOMaker.Runtime.MessagePack.EntityBase, IMyDTO2, IEquatable<MyDTO2>
    {
        ...
        {
            _Member1 = source.Member1 is null ? null : new DomainA.MessagePack.MyDTO1(source.Member1);
            _Member2 = new DomainA.MessagePack.MyDTO1(source.Member2);
        }
        ...
        // ------------------------------ Member2 ------------------------------
        [IgnoreMember]
        private MyOrg.DomainA.MessagePack.MyDTO1 _Member2 = MyOrg.DomainA.MessagePack.MyDTO1.Empty;

        [Key(2)]
        public MyOrg.DomainA.MessagePack.MyDTO1 Member2
        {
            get => _Member2;
            set => _Member2 = IfNotFrozen(ref value);
        }

        [IgnoreMember]
        MyOrg.DomainA.IMyDTO1 IMyDTO2.Member2
        {
            get => _Member2;
            set
            {
                ThrowIfFrozen();
                _Member2 = new MyOrg.DomainA.MessagePack.MyDTO1(value);
            }
        }
